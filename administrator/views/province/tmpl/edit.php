...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="province-form" class="form-validate form-horizontal">
	...
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				...
				<?php echo $this->form->renderField('provinces_code'); ?>
				<?php echo $this->form->renderField('provinces_name_th'); ?>
				<?php echo $this->form->renderField('provinces_name_en'); ?>
				<?php echo $this->form->renderField('provinces_geo_id'); ?>
				<?php echo $this->form->renderField('provinces_postcode_prefix'); ?>
				<?php echo $this->form->renderField('provinces_phone_area_code'); ?>
				<?php echo $this->form->renderField('provinces_zone'); ?>
				<?php echo $this->form->renderField('provinces_logo'); ?>
