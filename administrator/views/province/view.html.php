 ...
 * @since  1.6
 */
class ThailandareaViewProvince extends \Joomla\CMS\MVC\View\HtmlView
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(Text::_('COM_THAILANDAREA_TITLE_PROVINCE'), 'province.png');
		...
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_thailandarea.province', $this->item->id);
		}
