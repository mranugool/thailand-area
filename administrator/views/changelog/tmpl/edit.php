...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="changelog-form" class="form-validate form-horizontal">
	...
	<div class="row-fluid">
		<div class="span10 form-horizontal">
			<fieldset class="adminform">
				...
				<?php echo $this->form->renderField('changelog_version'); ?>
				<?php echo $this->form->renderField('changelogs_date'); ?>
				<?php echo $this->form->renderField('changelogs_detail'); ?>
				<?php echo $this->form->renderField('changelogs_tag'); ?>
